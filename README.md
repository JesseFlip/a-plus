# CompTIA A+ Study Map — 4-Day Sprint
...
**Live Demo:** [https://a-plus-study.netlify.app/](https://a-plus-study.netlify.app/)
...
## 📖 How to Use
1. **Clone the repo:** `git clone https://github.com/JesseFlip/a-plus.git`
2. **Local Preview:** Open `index.html` in any modern web browser.
3. **Updates:** Push to GitHub to trigger the CI/CD pipeline.
